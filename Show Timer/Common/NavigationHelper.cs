...
namespace ShowTimer.Common
{
    /// <summary>
    /// NavigationManager aide à naviguer entre les pages.  Il fournit les commandes utilisées pour 
    /// naviguer vers l'arrière et l'avant ainsi que des registres pour les raccourcis de souris et de clavier 
    /// utilisés pour reculer et avancer.  De plus, il intègre SuspensionManger
    /// pour la gestion de la durée de vie des processus et la gestion de l'état lors de la navigation dans les
    /// pages.
    /// </summary>
    /// <example>
    /// Pour utiliser NavigationManager, suivez les deux étapes ci-dessous ou
    /// commencer par BasicPage ou un autre modèle d'élément Page différent de BlankPage.
    /// 
    /// 1) Créer une instance de NavigationHelper dans un emplacement tel que 
    ...
    /// </code>
    /// 
    /// 2) Inscrire la page pour appeler NavigationManager lorsque la page participe 
